...
vae = torch.load('vae/1659672883257042/saved_models/epoch_34_env_0', map_location={'cuda:0': 'cpu'}).to(DEVICE)
...
plt.savefig('visual_constant1.png')

ax1 = plt.axes(projection='3d')
ax1.scatter3D(z_1, z_2, z_4, cmap='Blues', alpha=0.6)
plt.savefig('visual4_constant1.png')
